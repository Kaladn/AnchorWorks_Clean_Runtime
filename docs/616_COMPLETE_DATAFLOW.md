...
├────────────────────────────────────────────────────────────────┤
│                                                                 │
│  User uploads "doc1_anchorworks_ecology.txt"                       │
│         ↓                                                       │
...
│  ═══════════════════════════════════════                       │
│                                                                 │
│  For each anchor (e.g., "anchorworks"):                            │
│                                                                 │
│    total_count = 0                                             │
│                                                                 │
...
│    VALUES                                                       │
│      ('anchorworks', cite_id, map_id, total_count)                 │
│                                                                 │
│  RESULT:                                                        │
│  ┌──────────────────────────────────────────────────┐         │
│  │ anchor_index table                                │         │
...
│  │ anchor   │ cite_id │ map_id  │ count  │         │
│  ├──────────┼─────────┼─────────┼────────┤         │
│  │ anchorworks   │ cite_6c │ map_797 │ 33     │ ← SUM  │
...
├────────────────────────────────────────────────────────────────┤
│                                                                 │
│  User searches: ["anchorworks", "carbon"]                          │
│         ↓                                                       │
│  POST /api/library/query                                      │
│    {keywords: ["anchorworks", "carbon"], limit: 10}               │
│         ↓                                                       │
...
│  WHERE ai.anchor IN ('anchorworks', 'carbon')  ← KEYWORD MATCH    │
...
│                                                                 │
│  Example:                                                       │
│    doc1: matches "anchorworks" (33) + "carbon" (78)                │
│      → matched_count = 2                                       │
│      → total_mentions = 111                                    │
...
│      "filename": "doc1_anchorworks_ecology.txt",                   │
│      "score": 211.0,                                          │
│      "matched_anchors": ["anchorworks", "carbon"],                 │
│      "total_mentions": 111                                     │
│    },                                                           │
│    ...                                                          │
│  ]                                                              │
...
For anchor "anchorworks" with this structure:
```json
{
  "before": {
...
This represents: **Total co-occurrence weight** - how strongly "anchorworks" is connected to its context words across all 12 positions (6 before + 6 after).
